...
variable "existing_rts" {
  description = <<-EOF
    ...
    Name format should be option of \"fgt_login\", \"ngw_igw\". Or follow the name prefix of \"fgt_login_\", \"tgw_attachment_\", \"gwlbe_\", \"ngw_\", followed with availability zone name.
