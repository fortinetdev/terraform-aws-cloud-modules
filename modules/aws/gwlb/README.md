...
| <a name="input_gwlb_ep_service_name"></a> [gwlb\_ep\_service\_name](#input\_gwlb\_ep\_service\_name) | Gateway Load Balancer Endpoint Service name. | `string` | `"gwlb_endpoint_service"` | no |
