...
| <a name="input_fmg_integration"></a> [fmg\_integration](#input\_fmg\_integration) | Register FortiGate instance to the FortiManager. | <pre>object({<br/>    ip = string<br/>    sn = string<br/>    autoscale_psksecret = string<br/>    fmg_password = string<br/>    fgt_lic_mgmt = optional(string, "fmg")<br/>    hb_interval = optional(number, 10)<br/>  })</pre> | `null` | no |
